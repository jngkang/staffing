...
INSERT INTO `employee` (`empno`, `role_id`, `deptno`, `postno`, `name`, `sex`, `identify_no`, `nation`, `province`, `political`, `phone`, `address`, `password`, `state`, `avatar_url`) VALUES ('111111',2,'1001','001','1232',1,'412726199812302832','汉','河南','团员','13461321028','','123456',1,NULL),('123456',1,'1001','001','小小管理员',1,'123456123456781234','汉','河南','团员','12312341234','河南1','123456',1,'http://localhost:9090/files/648a60ec462a47a2a6aaa6f5c1f6d3f7.jpg'),('222222',2,'1002','003','1231',1,'412726199812302830','汉','河南','团员','13461321028','','123456',1,NULL);
...
CREATE TABLE `sys_icon` (
  ...
  PRIMARY KEY (`icon_id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='图标表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_icon` (`icon_id`, `name`, `icon`) VALUES (1,'用户','el-icon-user'),(7,'图标','el-icon-star-off'),(8,'主页','el-icon-house'),(9,'菜单','el-icon-menu'),(16,'角色','el-icon-s-custom'),(17,'菜单-s','el-icon-s-grid'),(18,'文件','el-icon-document'),(19,'文件','el-icon-folder-opened'),(20,'图标','el-icon-view'),(21,'标签','el-icon-collection-tag'),(22,'权限','el-icon-lock'),(25,'部门','el-icon-office-building'),(26,'岗位','el-icon-user-solid');
...
INSERT INTO `sys_role_menu` (`role_id`, `menu_id`) VALUES (1,1),(2,1),(1,2),(1,5),(1,17),(1,22),(1,23),(1,24),(1,31),(1,32),(1,33);
...
CREATE TABLE `vacation` (
  `vatno` int(11) NOT NULL AUTO_INCREMENT COMMENT '总请假编号',
  `empno` varchar(18) NOT NULL COMMENT '员工编号',
...
-- Dump completed on 2022-03-26 21:32:58
