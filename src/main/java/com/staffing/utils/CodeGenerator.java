...
//                    builder.author("JngKang") // 设置作者
                    builder
                            ...
                            .outputDir("D:\\Code\\GraduationProject\\staffingSchedulingSystem\\src\\main\\java\\"); // 指定输出目录

                })
                .packageConfig(builder -> {
                    builder.parent("com.staffing") // 设置父包名
                            .moduleName("") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D:\\Code\\GraduationProject\\staffingSchedulingSystem\\src\\main\\resources\\mapper\\")); // 设置mapperXml生成路径
                })
